...
function buildWhere(datasetId: string, filters: FilterParams): Prisma.ZendingWhereInput {
  const where: Prisma.ZendingWhereInput = { datasetId };
...
export async function getZendingen(
  datasetId: string,
